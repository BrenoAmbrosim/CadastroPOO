...
public class PessoaFisicaRepo implements Serializable {
    ...
    private ArrayList<PessoaFisica1> pessoasFisicas;
    
    public PessoaFisicaRepo() {
        pessoasFisicas = new ArrayList<>();
    }
    
    public boolean inserir(PessoaFisica1 pf) {
        return pessoasFisicas.contains(pf) ? false : pessoasFisicas.add(pf);
    }
        
    public boolean alterar(PessoaFisica1 pf) {
    ...
    public PessoaFisica1 obter(int id) {
    ...
    public ArrayList<PessoaFisica1> obterTodos() {
    ...
    public void recuperar(String filename) {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(filename))) {
            pessoasFisicas = (ArrayList<PessoaFisica1>) ois.readObject();
        }
