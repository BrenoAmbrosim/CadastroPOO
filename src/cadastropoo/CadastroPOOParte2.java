...
public class CadastroPOOParte2 {
    ...
    private final PessoaFisicaRepo repoPF;
    private final PessoaJuridicaRepo repoPJ;
            ...
            switch (opcao) {
                case "1": {
                    ...
                    if (escolhaIncluir.equals("F")) {
                        ...
                        repoPF.inserir(new PessoaFisica1(id, nome, cpf, idade));
                    }
                ...
                case "2": {
                    ...
                    if (escolhaAlterar.equals("F")) {
                        try {
                            int id = intAnswerQuestion("Informe o ID da Pessoa Fisica: ");
                            PessoaFisica1 pf = repoPF.obter(id);
                            if (pf != null) {
                ...
                case "5": {
                    System.out.println();
                    for (PessoaFisica1 pf : repoPF.obterTodos()) {
                        pf.exibir();
                    }
