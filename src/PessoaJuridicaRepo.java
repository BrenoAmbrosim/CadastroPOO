...
public class PessoaJuridicaRepo implements Serializable {
    ...
    private ArrayList<cadastropoo.model.PessoaJuridica> pessoasJuridicas;
    
    public PessoaJuridicaRepo() {
        pessoasJuridicas = new ArrayList<>();
    }
    
    public boolean inserir(cadastropoo.model.PessoaJuridica pj) {
        return pessoasJuridicas.contains(pj) ? false : pessoasJuridicas.add(pj);
    }
    
    public boolean alterar(cadastropoo.model.PessoaJuridica pj) {
    ...
    public cadastropoo.model.PessoaJuridica obter(int id) {
    ...
    public ArrayList<cadastropoo.model.PessoaJuridica> obterTodos() {
    ...
    public void recuperar(String filename) {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(filename))) {
            pessoasJuridicas = (ArrayList<cadastropoo.model.PessoaJuridica>) ois.readObject();
        }
